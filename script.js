...
let palabras = ["nieve", "hueso", "titan", "flujo", "disco", "razon", "mural", "abril", "vejez", "falso", "cañon", "obeso", "metal", "avena", "rubia", "pieza", "cuero", "noche", "bingo", "corto", "multa", "nieto", "dieta", "mosca", "nadal", "lider", "cerco", "rocio", "apoyo", "secta", "ganar", "besar", "novio", "albur", "litio", "llaga", "rueda", "corta", "feliz", "miope", "mojar", "cesta", "soplo", "nueve", "radio", "sexto", "sucio", "papel", "huevo", "polar", "rotar", "fuego", "lucir", "macho", "braza", "serio", "libra", "enano", "salsa", "ciego", "mujer", "sauna", "malta", "civil", "flota", "chile", "acudo", "modas", "criar", "hurto", "latir", "colin", "ganso", "suiza", "otoño", "suelo", "exito", "caber", "epica", "perra", "juego", "igneo", "ingle", "mango", "caida", "doler", "album", "sudar", "duque", "curro",
  ...
  "brida", "clima", "tapon", "jalon", "mugir", "dotar", "susto", "tieso", "tiesa", "santa", "lejia", "farsa", "casar", "balon", "galon", "dueño", "donde", "curar", "talco", "fuero", "soler", "listo", "graso", "mecha", "recia", "recio", "fideo", "marta", "suela", "marte", "venus", "pardo", "parda", "verde", "viola", "pisar", "mirar", "rizar", "ramal", "torpe", "limar", "lijar", "secar", "nacer", "dedal", "sedal", "pedal", "cesar", "celar", "telar", "judia", "trece", "adios", "menos", "fango", "llave", "trago", "colar"];
